(function() {
  ...
  function injectUI() {
    ...
    container.innerHTML = `
      <fieldset>
        <legend><img src="${chrome.runtime.getURL('icons/icon16.png')}" style="width:14px;height:14px;vertical-align:middle;margin-right:4px;image-rendering:pixelated;">E-Hentai Downloader</legend>
